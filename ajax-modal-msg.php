...
<div class="card card-body border-0">
  ...
  <input class="form-control chattextbox" style="height:50px;" id="ppt_chat_send_<?php echo $settings['pid']; ?>_chat_msg">
         ...
         jQuery('#sendmsgform<?php echo $randomnum; ?> #usernamefield').change(function() { 
             ...
             jQuery.ajax({
                 ...
                 success: function(response) {
         			...
         			if(response == "yes"){
         			jQuery('#sendmsgform<?php echo $randomnum; ?> .ajaxMsgUser').html('<span class="badge badge-success"><i class="fa fa-check-circle" aria-hidden="true"></i> <?php echo __("Valid Username","premiumpress"); ?></span>');
         			
					jQuery('#sendmsgform<?php echo $randomnum; ?> button').show();
					
					} else {
         			jQuery('#sendmsgform<?php echo $randomnum; ?> .ajaxMsgUser').html('<span class="badge badge-danger"><i class="fa fa-close" aria-hidden="true"></i> <?php echo __("Invalid Username","premiumpress"); ?></span>');
