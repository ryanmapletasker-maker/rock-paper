...
<h6 class="mb-3"><?php echo __("Seller","premiumpress") ?>:</h6>
      ...
      <div><strong><?php echo $CORE->USER("get_name", $sellerid); ?></strong></div>
    <div><?php echo $CORE->USER("get_address", $sellerid); ?></div>
    <div><?php echo $CORE->USER("get_phone", $sellerid); ?></div>
<?php }else{ ?>
