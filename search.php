...
<section class="bg-light section-40">
  <div class="<?php if(in_array($thisdesign,array('1','2')) || THEME_KEY == "ph" ){ ?>container container-full-width px-lg-5 px-md-4 mx-lg-2<?php }else{ ?>container<?php } ?>">
    <div class="row">
      ...
      <?php } ?>
      <div class="col">
        <div <?php if(in_array($thisdesign,array('5','6')) ){ ?>class="row px-0"<?php } ?>>
...
<input type="hidden" class="customfilter"  name="userid" data-type="text" data-key="userid" value="<?php echo $_GET['uid']; ?>" >
<?php } ?>
