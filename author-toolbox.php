...
<input type="hidden" id="orderdatafor<?php echo $post->ID; ?>" value="<?php if(!isset($data['order_description'])){ $data['order_description'] = ""; }
   ...
   echo $CORE->order_encode(array(   
   	...
   	"order_id" 		=> get_post_meta($lastorder['id'], 'order_id', true ),   	 
   ...
   <div class="box-alert bell box-shadow">
      <div class="box-alert-wrap">
        ...
        <?php if(!in_array(THEME_KEY, array("da") ) ){ ?>
         ...
         <?php /* if(get_post_meta($post->ID, "homepage", true) == 1){ ?>
         <a href="javascript:void(0);" class="text-success" style="cursor:default;"><i class="fa fa-check" aria-hidden="true"></i> <span class="tiny"><?php echo __("Homepage","premiumpress"); ?></span></a> 
         <?php } ?>
         
         <?php if(get_post_meta($post->ID, "sponsored", true) == 1){ ?>
         <a href="javascript:void(0);" class="text-success" style="cursor:default;"><i class="fa fa-check" aria-hidden="true"></i> <span class="tiny"><?php echo __("Sponsored","premiumpress"); ?></span></a>
         <?php } ?>
         
         <?php if(get_post_meta($post->ID, "featured", true) == 1){ ?>
         <a href="javascript:void(0);" class="text-success" style="cursor:default;"><i class="fa fa-check" aria-hidden="true"></i> <span class="tiny"><?php echo __("Featured","premiumpress"); ?></span></a>
         <?php }*/ ?>         
      </div>
   </div>
   </div>
