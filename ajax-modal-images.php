...
?>
  <div class="<?php if(count($files) == 1){?>col-12<?php }elseif(count($files) == 2){?>col-6<?php }else{ ?>col-6 col-md-4<?php } ?> mb-4"> <a href="<?php echo $f['src']; ?>"  data-toggle="lightbox" data-gallery="example-gallery" data-type="image"> <img src="<?php echo $f['thumbnail']; ?>" class="img-fluid shadow-sm border" alt="image <?php echo $i; ?>"> </a> </div>
  <?php $i++; } ?>
</div>
</div> 
<?php }else{ ?>
